   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="table.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fa-solid fa-trash-can"></i> delete </a>
               <a href="table.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fa-solid fa-pen-to-square"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data" class="add-product-form">
      ...
      <a value="cancel" id="close-edit" class="option-btn" href="table.php" >cancel</a>
